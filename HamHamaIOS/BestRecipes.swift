...
class BestRecipes: UIViewController,  UITableViewDelegate, UITableViewDataSource {
    
    var URL_GET_RECETTES = "http://192.168.64.2/foodapp/aimer_top10.php"
    ...
    @IBAction func switchTabs(_ sender: UISegmentedControl) {
        ...
        case 0:
            ...
            break
        case 1:
            URL_GET_RECETTES = "http://192.168.64.2/foodapp/categories/RecTunisianFood.php"
            getRecettes()
            break
        case 2:
            URL_GET_RECETTES = "http://192.168.64.2/foodapp/categories/RecDessert.php"
            getRecettes()
            break
        case 3:
            URL_GET_RECETTES = "http://192.168.64.2/foodapp/categories/RecDessert.php"
